<<<<<<< HEAD:Screens/setting/ChangePhone1.js
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={{width:'100%',height:40, justifyContent:'center', alignItems:'center',flexDirection:'row',marginTop:30}}>
                ...
                style={{width:'75%',height:40,borderBottomWidth:3, borderColor:'#574E92'}}
                ></TextInput>
            </View>
            
            <Pressable
            onPress={() => navigation.navigate('DoiSDT2')}
            style={{width:'90%',height:40,backgroundColor:'#574E92',borderRadius:20,marginTop:30}}>
...
>>>>>>> b22fb74c6eb6513ba9b45c65c60c800e9b3e4ed1:Screens/setting/accountsecurity/ChangePhone1.js
});