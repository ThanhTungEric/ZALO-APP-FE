<<<<<<< HEAD:Screens/setting/Message.js
    ...
    return (
        <View style={styles.container}>
            <View style={{ width: '100%', height: 40, backgroundColor: "#574E92", flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Text style={{color: 'white', left: 20, fontSize: 18 }}>Tin nhắn</Text>
            </View>
            <ScrollView style={{ width: '100%' }}>
                <View style={{ width: '100%', height: 'auto', backgroundColor: "#fff" }}>
                    ...
                    <Pressable
                        ...
                        <View style={{ width: '90%' }}>
                            <View style={{ height: 20 }}>
                                <Text>Quản lý tin nhắn nhanh</Text>
                            </View>
                        </View>
                        <View
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Gợi ý gửi ảnh vừa chụp</Text>
                            </View>
                        </View>
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Gợi ý sticker khi soạn tin nhắn</Text>
                            </View>
                        </View>
                        <View style={{ width: 'auto' }}>
                            <TouchableOpacity
                ...
                <View style={{ width: '100%', height: 'auto', backgroundColor: "#fff", marginTop: 10 }}>
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Gửi tin nhắn khi nhấn Enter trên bàn phím</Text>
                            </View>
                        </View>
                        <View style={{ width: 'auto' }}>
                            <TouchableOpacity
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Thả biểu tượng cảm xúc</Text>
                            </View>
                        </View>
                        <View style={{ width: 'auto' }}>
                            <TouchableOpacity
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Tự động phát tin nhắn thoại</Text>
                            </View>
                        </View>
                        <View style={{ width: 'auto' }}>
                            <TouchableOpacity
                    ...
                    <Pressable
                        ...
                        <View style={{ width: '90%' }}>
                            <View style={{ height: 20 }}>
                                <Text>Chọn vị trí bắt đầu đọc</Text>
                            </View>
                        </View>
                        <View
                            style={{ width: 40, height: 40, right: 20, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <View
                        ...
                        <View style={{ width: '80%', }}>
                            <View style={{ height: 20 }}>
                                <Text>Khôi phục trò chuyện vừa xóa</Text>
                            </View>
                        </View>
                        <View style={{ width: 'auto' }}>
                            <TouchableOpacity
...
>>>>>>> b22fb74c6eb6513ba9b45c65c60c800e9b3e4ed1:Screens/setting/message/Message.js
});