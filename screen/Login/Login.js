...
const Login = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={{ width: '100%', height: 50, backgroundColor: "#18A0FB", flexDirection: 'row', alignItems: 'center', justifyContent:'center' }}>

                <Text style={{ fontWeight: '600', color: 'white', fontSize: 18 }}>Đăng nhập</Text>
            </View>
            <View style={{ width: '100%', height: 50, justifyContent: 'center', alignItems: 'center' }}>
                <Text style= {{ }}>Bạn có thể đăng nhập bằng số điện thoại hoặc username</Text>
            </View>
            <View style={{ width: '100%', height: 'auto', justifyContent: 'center', alignItems: 'center' }}>
                <TextInput placeholder='Số điện thoại' placeholderTextColor={'#18A0FB'} 
                value={phoneNumber}
                style={{backgroundColor:'white',borderWidth:3,borderRadius:10,height:50,width:'90%'}}
                onChangeText={(text) => setPhoneNumber(text)}
                ></TextInput>
                <TextInput placeholder='Mật khẩu' placeholderTextColor={'#18A0FB'} 
            ...
            <View style={{ width: '100%', height: 50, justifyContent: 'center', alignItems: 'center',marginTop:20 }}>
                <TouchableOpacity 
                onPress={handleLogin}
                style={{ width: '90%', height: 50, backgroundColor: '#18A0FB', justifyContent: 'center', alignItems: 'center', borderRadius: 10 }}>
                    <Text style={{ fontWeight: '600', color: 'white', fontSize: 18 }}>Đăng nhập</Text>
                </TouchableOpacity>
            </View>
            <View style={{ width: '100%', height: 50, justifyContent: 'center', alignItems: 'center',marginTop:20 }}>
